...
export function TraineePractitionerDashboard({ user }: Props) {
  return (
    <div className="space-y-xl">
      ...
      <section>
        ...
        <div className="grid gap-md sm:grid-cols-2">
          <NHSCard
            icon="🎓"
            title="Assignments & Top Tips"
            description="Track your training assignments, review key clinical reminders, and access session scripts."
            linkTo="/training"
